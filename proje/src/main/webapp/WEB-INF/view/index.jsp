...
<head>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        'https://www.googletagmanager.com/gtm.js?analysis_id='+i+dl;f.parentNode.insertBefore(j,f);
    })(window,document,'script','dataLayer','GTM-5LMTFJK');</script>
...
<body onpagehide="sendExpiringTime()" onunload="sendExpiringTime()">
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?analysis_id=GTM-5LMTFJK"
...
<!-- End Google Tag Manager (noscript) -->
                        ...
                        <nav>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    ...
                                    <a href="/home/about">About <span class="fa fa-angle-down" aria-hidden="true"></span></a>
                                    <input type="checkbox" analysis_id="drop-2" />
                                    <ul class="inner-dropdown">
                                        <li><a href="/home/about">Stats</a></li>
                                        <li><a href="/home/about">Team</a></li>
                                        <li><a href="/home/about">Reviews</a></li>
                                    </ul>
                                </li>
    ...
    <!-- //banner -->
    <!-- //banner-botttom -->
    <section class="content-info py-5" analysis_id="about2">
        <div class="container py-md-5">
            <div class="text-center px-lg-5">
                <div class="title-desc text-center px-lg-5">
                    ...
                    <a class="btn mt-lg-4 mt-3 read" href="/home/single" role="button"><span class="fa fa-play" aria-hidden="true"></span></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 progress-content-img px-lg-0">
                    <img src="/resources/images/img1.jpg" alt="" class="img-fluid image1">
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 progress-content-img two px-lg-0">
                    <img src="/resources/images/img2.jpg" alt="" class="img-fluid image1">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container py-md-5">
            ...
            <div class="feature-grids row mt-5">
                ...
                <div class="col-lg-4 gd-bottom text-center">
                    <img src="/resources/images/process.png" alt="" class="img-fluid image1">
                </div>
            ...
            <div class="gallery-content">
                <div class="row">
                    <div class="col-md-4 col-sm-6 gal-img">
                        <a href="#gal1"><img src="/resources/images/g1.jpg" alt="aegis" class="img-fluid mt-4"></a>
                    </div>
                    <div class="col-md-4 col-sm-6 gal-img">
                        <a href="#gal2"><img src="/resources/images/g2.jpg" alt="aegis" class="img-fluid mt-4"></a>
                    </div>
                    <div class="col-md-4 col-sm-6 gal-img">
                        <a href="#gal3"><img src="/resources/images/g3.jpg" alt="aegis" class="img-fluid mt-4"></a>
                    </div>
                    <div class="col-md-4 col-sm-6 gal-img">
                        <a href="#gal4"><img src="/resources/images/g4.jpg" alt="aegis" class="img-fluid mt-4"></a>
                    </div>
                    <div class="col-md-4 col-sm-6 gal-img">
                        <a href="#gal5"><img src="/resources/images/g5.jpg" alt="aegis" class="img-fluid mt-4"></a>
                    </div>
                    <div class="col-md-4 col-sm-6 gal-img">
                        <a href="#gal6"><img src="/resources/images/g6.jpg" alt="aegis" class="img-fluid mt-4"></a>
                    </div>
                ...
                <div analysis_id="gal1" class="popup-effect">
                    <div class="popup">
                        <img src="/resources/images/g1.jpg" alt="Popup image" class="img-fluid mt-4" />
                ...
                <div analysis_id="gal2" class="popup-effect">
                    <div class="popup">
                        <img src="/resources/images/g2.jpg" alt="Popup image" class="img-fluid mt-4" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div analysis_id="gal3" class="popup-effect">
                    <div class="popup">
                        <img src="/resources/images/g3.jpg" alt="Popup image" class="img-fluid mt-4" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div analysis_id="gal4" class="popup-effect">
                    <div class="popup">
                        <img src="/resources/images/g4.jpg" alt="Popup image" class="img-fluid mt-4" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div analysis_id="gal5" class="popup-effect">
                    <div class="popup">
                        <img src="/resources/images/g5.jpg" alt="Popup image" class="img-fluid mt-4" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div analysis_id="gal6" class="popup-effect">
                    <div class="popup">
                        <img src="/resources/images/g6.jpg" alt="Popup image" class="img-fluid mt-4" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
    ...
    <footer class="footer-content py-5">
        <div class="container py-md-3">
            <div class="footer-top text-center mb-5">
                <h2>
                    <a class="navbar-brand pt-3 mb-5" href="/home/index">
                        <span class="fa fa-angellist"></span> Aegis
                    </a>
                </h2>
                ...
                <div class="col-lg-3 col-md-6 mt-lg-0 mt-4">
                    <div class="footer-lavi">
                        ...
                        <ul class="list-info-lavi">
                            <li>
                                <a href="/home/about"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
                                    Our Mission
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="/home/contact"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
                                    Find us
                                </a>
                            </li>
                            <li>
                ...
                <div class="col-lg-3 col-md-6 mt-lg-0 mt-4">
                    <div class="footer-lavi">
                        ...
                        <ul class="list-info-lavi">
                            ...
                            <li>
                                <a href="/home/single"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
                                    Single Page
                                </a>
                            </li>
                            <li>
...
<script>
    function sendExpiringTime() {
        ...
        $.ajax({
            ...
            data:{date2:JSON.stringify(date)}
        });
    }
