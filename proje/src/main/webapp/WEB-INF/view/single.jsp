                        ...
                        <div class="nav_section">
                            <nav>
                                ...
                                <ul class="menu">
                                    ...
                                    <li><a href="/home/index">Features</a></li>
        ...
        <div class="container py-md-5">
            ...
            <div class="single-lavi-page mt-md-5 mt-4 px-lg-5">
                <div class="content-sing-w3layouts px-lg-5">
                    <img class="img-fluid" src="/resources/images/banner3.jpg" alt="">
                ...
                <div class="row my-lg-5 my-3 mx-0">
                    ...
                    <div class="col-lg-6 team-img">
                        <div class="row">
                            <div class="col-lg">
                                <img src="/resources/images/g2.jpg" class="img-fluid" alt="user-image">
                            </div>
                            <div class="col-lg">
                                <img src="/resources/images/g4.jpg" class="img-fluid" alt="user-image">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="comment-sec-w3layouts">
                    ...
                    <ul class="list-unstyled">
                        <li class="media">
                            <img class="mr-3 img-fluid" src="/resources/images/m1.jpg" alt="">
                        ...
                        <li class="media my-5 ml-3">
                            <img class="mr-3 img-fluid" src="/resources/images/m2.jpg" alt="">
                            <div class="media-body">
                        ...
                        <li class="media ml-5">
                            <img class="mr-3 img-fluid" src="/resources/images/m3.jpg" alt="">
                            <div class="media-body">
