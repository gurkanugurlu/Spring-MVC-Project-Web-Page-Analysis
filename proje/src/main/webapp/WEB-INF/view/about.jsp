...
<body onunload="sendExpiringTime()" onpagehide="sendExpiringTime()">
                ...
                <div class="container">
                    <div class="header d-lg-flex justify-content-between align-items-center">
                        <div class="header-section">
                            <h1>
                                <a class="navbar-brand logo editContent" href="/home/about">
                        ...
                        <div class="nav_section">
                            <nav>
                                ...
                                <ul class="menu">
                                    ...
                                    <li><a href="/home/about">Features</a></li>
                                    ...
                                    <li><a href="/home/index">Skills</a></li>
                                    <li><a href="/home/index">Portfolio</a></li>
        ...
        <div class="container py-md-5">
            ...
            <div class="feature-grids team row mt-3">
                <div class="col-lg-4 gd-bottom team-wthree-gd mt-4">
                    <div class="bottom-gd p-lg-5 p-4">
                        <img src="/resources/images/team1.jpg" alt="" class="img-fluid image1">
                        <h3 class="my-3">
                            Fletch Skinner</h3>
                ...
                <div class="col-lg-4 gd-bottom team-wthree-gd mt-4">
                    <div class="bottom-gd2-active p-lg-5 p-4">
                        <img src="/resources/images/team2.jpg" alt="" class="img-fluid image1">
                ...
                <div class="col-lg-4 gd-bottom team-wthree-gd mt-4">
                    <div class="bottom-gd p-lg-5 p-4">
                        <img src="/resources/images/team3.jpg" alt="" class="img-fluid image1">
            ...
            <div class="row footer-top-inner-w3layouts">
                ...
                <div class="col-lg-3 col-md-6 mt-lg-0 mt-4">
                    <div class="footer-lavi">
                        ...
                        <ul class="list-info-lavi">
                            <li>
                                <a href="/home/index"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
                                    Home
                                </a>
                            </li>
                            <li>
...
<script>
    function sendExpiringTime() {
        ...
        $.ajax({
            ...
            data:{date3:JSON.stringify(date)}
        });
    }
